...
public class ToastUtil {
    ...
    public static void showShort(final String format, final Object... args) {
        show(format == null ? NULL : format, Toast.LENGTH_SHORT);
    }
    ...
    public static void showLong(final String format, final Object... args) {
        show(format == null ? NULL : format, Toast.LENGTH_LONG);
    }
    ...
    private static void show(final int resId, final int duration) {
        try {
            ...
            CharSequence text = app.getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final String format, final int duration, final Object... args) {
        ...
        if (format == null) {
            ...
            try {
                ...
                //format可能出现 java.util.MissingFormatArgumentException: Format specifier: 7B
                e.printStackTrace();
            }
        }
        show(text, duration);
...
//                }
            ...
            mParams.packageName = app.getPackageName();
